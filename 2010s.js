...
document.addEventListener("DOMContentLoaded", function () {
  ...
  const topicsContent = {
    history: [
      {
        media: "<img src='img/brexit_flag.jpg' style='width:100%; border-radius:4px;'>",
        text: `
      <ul>
    ...
    music: [
      {
        media: "<img src='img/album.jpg' style='width:75%; border-radius:4px;'>",
        text: `
      <ul>
    ...
    politics: [
      {
        media: "<img src='img/Trump_rally.jpg' style='width:90%; border-radius:8px;'>",
        text: `
      <ul>
    ...
    fashion: [
      {
        media: "<img src='img/Fashion.jpg' style='width:90%; border-radius:8px;'>",
        text: `
      <ul>
    ...
    food: [
      {
        media: "<img src='img/Avocado_toast.jpg' style='width:90%; border-radius:8px;'>",
        text: `
      <ul>
    ...
    technology: [
      {
        media: "<img src='img/early-iphone-android.jpg' style='width:100%; border-radius:8px;'>",
        text: `
      <ul>
    ...
    sports: [
      {
        media: "<img src='img/athletes.jpg' style='width:100%; border-radius:8px;'>",
        text: `
      <ul>
